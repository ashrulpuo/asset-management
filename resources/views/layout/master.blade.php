      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            </script>, develop by ashrul <i class="material-icons">favorite</i>Template from <a href="https://www.creative-tim.com" target="_blank">Creative Tim</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
